...
//Create Db
$this->createDb($username,$password,'urmilaca_dbastute');

//Create User
$this->createUser($username,$password,'astute','!@#gmawd6');

//Add user to DB - ALL Privileges
$this->addUserToDb($username,$password,'astute','urmilaca_dbastute','&ALL=ALL');

//Add user to DB - SELECTED PRIVILEGES
$this->addUserToDb($username,$password,'astute','urmilaca_dbastute','&CREATE=CREATE&ALTER=ALTER');
