                ...
                <div class="box box-primary">
                    <div class="row">  
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="box-body">
                                <form role="form" name="myForm" method="POST" enctype="multipart/form-data" action="<?php echo ADMIN_URL ?>/Sendinstance/" onsubmit="return validateForm()">  
                                    ...
                                    <div class="form-group"> 
                                        <div class="row">
                                            <label for="message_for" class="col-md-3"> Message For :</label>
                                            <div class="col-md-9">
                                                ...
                                                <select name="msg_for" class="form-control" id="message_for" >
                                                    <?php foreach ($get_msg_for as $get_msg) { ?>
                                                        ...
                                                        if ($get_api_status['status_two'] == 'Active') {
                                                            ...
                                                            if ($get_msg['for_name'] != 'None') {                                                               
                                                            ?>
                                                            <option value="<?php echo $get_msg['for_name'] ?>"  <?php if ($get_msg['for_name'] == 'None') { ?> <?php } ?> > <?php echo $get_msg['for_name']; ?></option>
                                                        <?php } } ?>
                                                    <?php } ?>                                    
                                                </select> 
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <textarea type="text" name="mobile_no" style="height: 150px;" id="mobile_no" class="form-control" placeholder="Enter number" required></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" style="height: 150px;" value="" name="message" id="text_messagee" >Dear Parents, </textarea>   
