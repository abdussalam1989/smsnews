                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo ADMIN_URL ?>/Sendtogroup" onsubmit="return confirmation()">  
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="static_value">[name]</span> <span class="static_value">[todaydate]</span> 
