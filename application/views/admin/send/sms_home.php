        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo ADMIN_URL . '/sms/send'; ?>">Send Sms</a></li>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="box box-primary">
                            <div class="box-body">
                                <form action="<?php echo ADMIN_URL ?>/send/getwork" enctype="multipart/form-data" method="POST">    
                                    <div class="col-md-2"></div>
                                    <div class="col-md-2">
                                        <label> Class :</label>
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <select name="class_name" class="form-control" id="class_name" onchange='this.form.submit()'>
                                                        ...
                                                        <tr>  
                                                            ...
                                                            <td><div id="mydiv"><input type="checkbox" name="mul_id" class="checkBoxClass" value="<?php
                                                                    if (!empty($student['mobile_no'])) {
                                                                        echo $student['mobile_no'] . '(' . $student['name'] . ')';
                                                                    }
                                                                    ?> "></div></td>
                                                        </tr>  
                                                        <?php
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo ADMIN_URL ?>/send/homework" onsubmit="return confirmation()">  
                                ...
                                <?php } else { } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!--<input type="checkbox" name="alternate_no" id="alternate_no"  ><span class="ab"> Check if sms send to alternate number. </span> -->
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control"  name="message" id="text_messagee" style="height: 150px;" placeholder="Messsage">Dear Parents, </textarea>   
...
<!--                                        <input type="hidden" name="current_url" id="current_url" value="<?php echo current_url(); ?>">-->
                                ...
                                <div class="col-md-12 form-group">
                                    Assignment Subject :
                                    <?php if (empty($get_home_template)) { ?>
                                        <b> No Template found </b>
                                        <?php
                                    } else {
                                        foreach ($get_home_template as $sms):
                                            ?>
                ...
                <!--<div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-body">
                                <h1><center>SMS Report</center></h1> 
                                <div id="report_table">
...
<script>
                                    $.ajax({
                                        url:  '<?php echo base_url() . $this->config->item('admin_folder'); ?>/send/sms_report_table/Homework',
                                    }).done(function (data) {
