                                        ...
                                        <?php if (empty($get_teacher_list)) { ?>
                                            <table id="example2" class="table table-bordered table-striped">
                                                <thead> <tr>
                                                        ...
                                                        <th id="mydiv" width="3%"><input type="checkbox" id="ckbCheckAll2" name="head_checkbox"></th>
                                                    </tr></thead>
                                            </table>
                                        <?php } else { ?>  
                                            <table id="" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $cnt = 1;
                                                    foreach ($get_teacher_list as $teach) {
                                                        ?>
                                                        <tr>  
                                                            <td><?php echo $cnt; ?></td> 
                                                            <td><?php echo $teach['employ_id']; ?></td>  
                                                            <td><?php echo $teach['name']; ?></td>  
                                                            <td><?php echo $teach['mobile_no']; ?></td>
                                                            <td><div id="mydiv"><input type="checkbox" name="mul_id" class="checkBoxClass" value="<?php
                                                                    if (!empty($teach['mobile_no'])) {
                                                                        echo $teach['mobile_no'] . '(' . $teach['name'] . ')';
                                                                    }
                                                                    ?> "></div> </td>
                                                        </tr>  
                                                        <?php
                    ...
                    <div class="col-md-5">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <label class="col-md-9"><span class="has-error"></span></label>
                                <span class="has-error"><?php echo $this->session->flashdata('error_msg'); ?></span>
                            </div>
                            <div class="box-body">
                                <form role="form" method="POST" enctype="multipart/form-data" action="<?php echo ADMIN_URL ?>/Sendtotec/teacher" onsubmit="return validateForm()" >  
                                    ...
                                    <div class="form-group">
                                        <textarea name="mobile_no" required="required" id="mobile_no" class="form-control mobile_number" placeholder="Mobile Number"></textarea>   
