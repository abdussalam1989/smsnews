                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <span class="btn btn-default clr"> Note : Please always use .csv file only. and fields Titles Should be like this ("name","employ_id","mobile_no","email") </span>
                            <a class="btn btn-default pull-right" href="<?php echo base_url();?>upload/csv/sample_sheet_class_teacher.csv" download>Download Sample Sheet</a>
                            <div class="btn-group pull-right"></div>
                        </div><!-- /.box-header -->
                <div class="box-body">
                      
                    <form action="<?php echo ADMIN_URL ?>/teacher/import" enctype="multipart/form-data" method="POST">
